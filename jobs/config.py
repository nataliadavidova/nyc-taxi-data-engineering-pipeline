...
BRONZE_TASK_EXECUTION_TIMEOUT_MINUTES = int(
    os.getenv("BRONZE_TASK_EXECUTION_TIMEOUT_MINUTES", "10")
)
SILVER_TASK_EXECUTION_TIMEOUT_MINUTES = int(
    os.getenv("SILVER_TASK_EXECUTION_TIMEOUT_MINUTES", "20")
)
SILVER_QUALITY_TASK_EXECUTION_TIMEOUT_MINUTES = int(
    os.getenv("SILVER_QUALITY_TASK_EXECUTION_TIMEOUT_MINUTES", "5")
)
GOLD_STANDARD_TASK_EXECUTION_TIMEOUT_MINUTES = int(
    os.getenv("GOLD_STANDARD_TASK_EXECUTION_TIMEOUT_MINUTES", "8")
)
GOLD_LOCATION_TASK_EXECUTION_TIMEOUT_MINUTES = int(
    os.getenv("GOLD_LOCATION_TASK_EXECUTION_TIMEOUT_MINUTES", "10")
)
GOLD_SCHEMA_TASK_EXECUTION_TIMEOUT_MINUTES = int(
    os.getenv("GOLD_SCHEMA_TASK_EXECUTION_TIMEOUT_MINUTES", "5")
)
CLICKHOUSE_LOAD_TASK_EXECUTION_TIMEOUT_MINUTES = int(
    os.getenv("CLICKHOUSE_LOAD_TASK_EXECUTION_TIMEOUT_MINUTES", "5")
)
